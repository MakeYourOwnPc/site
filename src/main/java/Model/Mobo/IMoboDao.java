...
public interface IMoboDao<E extends Exception>{
    ...
    ArrayList<Mobo> doRetrieveByEverything(String ramSocket,String cpuSocket,String formFactor,int nvmeSlot,int sataSlot,int ramSlot,int limit, int offset) throws E;
